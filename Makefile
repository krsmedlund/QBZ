...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Oct 2 23:21:10 2011
# Project:  QBZ.pro
# Template: app
...
SOURCES       = src/System/main.cpp \
		...
		src/GL/finalout.cpp moc_mainwindow.cpp \
		moc_midithread.cpp \
		moc_ofwidget.cpp \
		qrc_QBZ.cpp
OBJECTS       = main.o \
...
modelfile.o: src/World/modelfile.cpp src/World/modelfile.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modelfile.o src/World/modelfile.cpp

finalout.o: src/GL/finalout.cpp src/GL/finalout.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o finalout.o src/GL/finalout.cpp
